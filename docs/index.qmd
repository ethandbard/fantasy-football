...
One page per team: average, ceiling, floor, projection delta, and points for and against with their league rank; a week-by-week bar chart against the league average; a game log; range vs the league (floor, ceiling, and median next to the league's); and every head-to-head matchup for that team, sorted by average margin, with the opponents not yet played named underneath. The full head-to-head grid stays on the League page.
:::
